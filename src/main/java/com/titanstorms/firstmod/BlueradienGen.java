...
public class BlueradienGen implements IWorldGenerator{
...
case -1:
	...
	public void generateNether(World world, Random rand, int x , int z) {
		generateOre(Firstmod.blueradien,world,rand, x,z,2,10,5,0 ,100, Blocks.end_stone);
	}
	public void generateOverworld(World world, Random rand, int x , int z) {
		generateOre(Firstmod.blueradien,world,rand, x,z,2,10,5,0 ,100, Blocks.stone);
	}
	public void generateEnd(World world, Random rand, int x , int z) {
		generateOre(Firstmod.blueradien,world,rand, x,z,2,10,5,0 ,100, Blocks.netherrack);
	}
