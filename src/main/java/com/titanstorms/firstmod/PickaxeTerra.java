...
public class PickaxeTerra extends ItemPickaxe {
	...
	public PickaxeTerra(ToolMaterial material) {
		super(material);
		this.setUnlocalizedName("PickaxeTerra").setTextureName("ts:itemtable").setCreativeTab(CreativeTabs.tabTools);
	...
	public boolean hitEntity(ItemStack par1ItemStack, EntityLivingBase par2EntityLiving, EntityLivingBase par3EntityLiving)
	{
		...
		par3EntityLiving.addPotionEffect(new PotionEffect(Potion.moveSpeed.id,20000,1));
		par3EntityLiving.addPotionEffect(new PotionEffect(Potion.fireResistance.id,20000,1));
		par3EntityLiving.addPotionEffect(new PotionEffect(Potion.waterBreathing.id,20000,1));
		par3EntityLiving.addPotionEffect(new PotionEffect(Potion.nightVision.id,20000,1));
		par3EntityLiving.addPotionEffect(new PotionEffect(Potion.resistance.id,20000,1));
		par3EntityLiving.addPotionEffect(new PotionEffect(Potion.invisibility.id,20000,1));
		par3EntityLiving.addPotionEffect(new PotionEffect(Potion.jump.id,20000,1));
		
		par3EntityLiving.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(200);
		par2EntityLiving.addPotionEffect(new PotionEffect(Potion.blindness.id,2000,1));
		...
		par2EntityLiving.addPotionEffect(new PotionEffect(Potion.digSlowdown.id,2000,1));
		...
		par2EntityLiving.addPotionEffect(new PotionEffect(Potion.moveSlowdown.id,2000,1));
		par2EntityLiving.addPotionEffect(new PotionEffect(Potion.confusion.id,2000,1));
