...
case -1:
	...
	public void generateNether(World world, Random rand, int x , int z) {
		generateOre(Titanpower.bluradien,world,rand, x,z,2,10,5,0 ,100, Blocks.end_stone);
	}
	public void generateOverworld(World world, Random rand, int x , int z) {
		generateOre(Titanpower.bluradien,world,rand, x,z,2,10,5,0 ,100, Blocks.stone);
	}
	public void generateEnd(World world, Random rand, int x , int z) {
		generateOre(Titanpower.bluradien,world,rand, x,z,2,10,5,0 ,100, Blocks.netherrack);
	}
